...
// The literal 0..STANDARD_VECTOR_SIZE-1. Regenerate this table if STANDARD_VECTOR_SIZE changes.
static_assert(STANDARD_VECTOR_SIZE == 1024, "INCREMENTAL_VECTOR below is generated for STANDARD_VECTOR_SIZE == 1024");

const sel_t FlatVector::INCREMENTAL_VECTOR[STANDARD_VECTOR_SIZE] = {
