...
using bumblebee::thrift::transport::TTransport;
...
public:
  ...
  uint32_t skip(TType type) { return ::bumblebee::thrift::protocol::skip(*this, type); }
...
public:
  ...
  uint32_t skip(TType type) {
    ...
    return ::bumblebee::thrift::protocol::skip(*prot, type);
  }
