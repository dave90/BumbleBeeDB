 ...
 *
 */
class TProtocolException : public bumblebee::thrift::TException {
public:
  /**
  ...
  TProtocolException() : bumblebee::thrift::TException(), type_(UNKNOWN) {}

  TProtocolException(TProtocolExceptionType type) : bumblebee::thrift::TException(), type_(type) {}
