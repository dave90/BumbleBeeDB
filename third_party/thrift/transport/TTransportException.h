 ...
 *
 */
class TTransportException : public bumblebee::thrift::TException {
public:
  /**
  ...
  TTransportException() : bumblebee::thrift::TException(), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type) : bumblebee::thrift::TException(), type_(type) {}

  TTransportException(const std::string& message)
    : bumblebee::thrift::TException(message), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type, const std::string& message)
    : bumblebee::thrift::TException(message), type_(type) {}
