...
const std::map<int, const char*> _Type_VALUES_TO_NAMES(::bumblebee::thrift::TEnumIterator(8, _kTypeValues, _kTypeNames), ::bumblebee::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _ConvertedType_VALUES_TO_NAMES(::bumblebee::thrift::TEnumIterator(22, _kConvertedTypeValues, _kConvertedTypeNames), ::bumblebee::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _FieldRepetitionType_VALUES_TO_NAMES(::bumblebee::thrift::TEnumIterator(3, _kFieldRepetitionTypeValues, _kFieldRepetitionTypeNames), ::bumblebee::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _Encoding_VALUES_TO_NAMES(::bumblebee::thrift::TEnumIterator(8, _kEncodingValues, _kEncodingNames), ::bumblebee::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _CompressionCodec_VALUES_TO_NAMES(::bumblebee::thrift::TEnumIterator(7, _kCompressionCodecValues, _kCompressionCodecNames), ::bumblebee::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _PageType_VALUES_TO_NAMES(::bumblebee::thrift::TEnumIterator(4, _kPageTypeValues, _kPageTypeNames), ::bumblebee::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _BoundaryOrder_VALUES_TO_NAMES(::bumblebee::thrift::TEnumIterator(3, _kBoundaryOrderValues, _kBoundaryOrderNames), ::bumblebee::thrift::TEnumIterator(-1, NULL, NULL));
...
uint32_t Statistics::read(::bumblebee::thrift::protocol::TProtocol* iprot) {

  ::bumblebee::thrift::protocol::TInputRecursionTracker tracker(*iprot);
  uint32_t xfer = 0;
  std::string fname;
  ::bumblebee::thrift::protocol::TType ftype;
  int16_t fid;

  xfer += iprot->readStructBegin(fname);

  using ::bumblebee::thrift::protocol::TProtocolException;


  while (true)
  {
    xfer += iprot->readFieldBegin(fname, ftype, fid);
    if (ftype == ::bumblebee::thrift::protocol::T_STOP) {
      break;
    }
    switch (fid)
    {
      case 1:
        if (ftype == ::bumblebee::thrift::protocol::T_STRING) {
      ...
      case 2:
        ...
        break;
      case 3:
        if (ftype == ::bumblebee::thrift::protocol::T_I64) {
...
uint32_t Statistics::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Statistics");

  if (this->__isset.max) {
    xfer += oprot->writeFieldBegin("max", ::bumblebee::thrift::protocol::T_STRING, 1);
    xfer += oprot->writeBinary(this->max);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.min) {
    xfer += oprot->writeFieldBegin("min", ::bumblebee::thrift::protocol::T_STRING, 2);
    xfer += oprot->writeBinary(this->min);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.null_count) {
    xfer += oprot->writeFieldBegin("null_count", ::bumblebee::thrift::protocol::T_I64, 3);
    xfer += oprot->writeI64(this->null_count);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.distinct_count) {
    xfer += oprot->writeFieldBegin("distinct_count", ::bumblebee::thrift::protocol::T_I64, 4);
    xfer += oprot->writeI64(this->distinct_count);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.max_value) {
    xfer += oprot->writeFieldBegin("max_value", ::bumblebee::thrift::protocol::T_STRING, 5);
    xfer += oprot->writeBinary(this->max_value);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.min_value) {
    xfer += oprot->writeFieldBegin("min_value", ::bumblebee::thrift::protocol::T_STRING, 6);
...
void Statistics::printTo(std::ostream& out) const {
  using ::bumblebee::thrift::to_string;
  out << "Statistics(";
...
uint32_t StringType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t StringType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t UUIDType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t UUIDType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t MapType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t MapType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t ListType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t ListType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t EnumType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t EnumType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t DateType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t DateType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t NullType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t NullType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t DecimalType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    {
      case 1:
        if (ftype == ::bumblebee::thrift::protocol::T_I32) {
...
uint32_t DecimalType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DecimalType");

  xfer += oprot->writeFieldBegin("scale", ::bumblebee::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32(this->scale);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("precision", ::bumblebee::thrift::protocol::T_I32, 2);
...
uint32_t MilliSeconds::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t MilliSeconds::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t MicroSeconds::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t MicroSeconds::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t NanoSeconds::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t NanoSeconds::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t TimeUnit::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    {
      case 1:
        if (ftype == ::bumblebee::thrift::protocol::T_STRUCT) {
...
uint32_t TimeUnit::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TimeUnit");

  if (this->__isset.MILLIS) {
    xfer += oprot->writeFieldBegin("MILLIS", ::bumblebee::thrift::protocol::T_STRUCT, 1);
    xfer += this->MILLIS.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.MICROS) {
    xfer += oprot->writeFieldBegin("MICROS", ::bumblebee::thrift::protocol::T_STRUCT, 2);
    xfer += this->MICROS.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.NANOS) {
    xfer += oprot->writeFieldBegin("NANOS", ::bumblebee::thrift::protocol::T_STRUCT, 3);
...
uint32_t TimestampType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    {
      case 1:
        if (ftype == ::bumblebee::thrift::protocol::T_BOOL) {
...
uint32_t TimestampType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TimestampType");

  xfer += oprot->writeFieldBegin("isAdjustedToUTC", ::bumblebee::thrift::protocol::T_BOOL, 1);
  xfer += oprot->writeBool(this->isAdjustedToUTC);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("unit", ::bumblebee::thrift::protocol::T_STRUCT, 2);
...
uint32_t TimeType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t TimeType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t IntType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    {
      case 1:
        if (ftype == ::bumblebee::thrift::protocol::T_BYTE) {
...
uint32_t IntType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("IntType");

  xfer += oprot->writeFieldBegin("bitWidth", ::bumblebee::thrift::protocol::T_BYTE, 1);
  xfer += oprot->writeByte(this->bitWidth);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("isSigned", ::bumblebee::thrift::protocol::T_BOOL, 2);
...
uint32_t JsonType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t JsonType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t BsonType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t BsonType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t LogicalType::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t LogicalType::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("LogicalType");

  if (this->__isset.STRING) {
    xfer += oprot->writeFieldBegin("STRING", ::bumblebee::thrift::protocol::T_STRUCT, 1);
    xfer += this->STRING.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.MAP) {
    xfer += oprot->writeFieldBegin("MAP", ::bumblebee::thrift::protocol::T_STRUCT, 2);
    xfer += this->MAP.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.LIST) {
    xfer += oprot->writeFieldBegin("LIST", ::bumblebee::thrift::protocol::T_STRUCT, 3);
    xfer += this->LIST.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.ENUM) {
    xfer += oprot->writeFieldBegin("ENUM", ::bumblebee::thrift::protocol::T_STRUCT, 4);
    xfer += this->ENUM.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.DECIMAL) {
    xfer += oprot->writeFieldBegin("DECIMAL", ::bumblebee::thrift::protocol::T_STRUCT, 5);
    xfer += this->DECIMAL.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.DATE) {
    xfer += oprot->writeFieldBegin("DATE", ::bumblebee::thrift::protocol::T_STRUCT, 6);
    xfer += this->DATE.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.TIME) {
    xfer += oprot->writeFieldBegin("TIME", ::bumblebee::thrift::protocol::T_STRUCT, 7);
    xfer += this->TIME.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.TIMESTAMP) {
    xfer += oprot->writeFieldBegin("TIMESTAMP", ::bumblebee::thrift::protocol::T_STRUCT, 8);
    xfer += this->TIMESTAMP.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.INTEGER) {
    xfer += oprot->writeFieldBegin("INTEGER", ::bumblebee::thrift::protocol::T_STRUCT, 10);
    xfer += this->INTEGER.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.UNKNOWN) {
    xfer += oprot->writeFieldBegin("UNKNOWN", ::bumblebee::thrift::protocol::T_STRUCT, 11);
    xfer += this->UNKNOWN.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.JSON) {
    xfer += oprot->writeFieldBegin("JSON", ::bumblebee::thrift::protocol::T_STRUCT, 12);
    xfer += this->JSON.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.BSON) {
    xfer += oprot->writeFieldBegin("BSON", ::bumblebee::thrift::protocol::T_STRUCT, 13);
    xfer += this->BSON.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.UUID) {
    xfer += oprot->writeFieldBegin("UUID", ::bumblebee::thrift::protocol::T_STRUCT, 14);
...
uint32_t SchemaElement::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t SchemaElement::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("SchemaElement");

  if (this->__isset.type) {
    xfer += oprot->writeFieldBegin("type", ::bumblebee::thrift::protocol::T_I32, 1);
    xfer += oprot->writeI32((int32_t)this->type);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.type_length) {
    xfer += oprot->writeFieldBegin("type_length", ::bumblebee::thrift::protocol::T_I32, 2);
    xfer += oprot->writeI32(this->type_length);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.repetition_type) {
    xfer += oprot->writeFieldBegin("repetition_type", ::bumblebee::thrift::protocol::T_I32, 3);
    xfer += oprot->writeI32((int32_t)this->repetition_type);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldBegin("name", ::bumblebee::thrift::protocol::T_STRING, 4);
  xfer += oprot->writeString(this->name);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.num_children) {
    xfer += oprot->writeFieldBegin("num_children", ::bumblebee::thrift::protocol::T_I32, 5);
    xfer += oprot->writeI32(this->num_children);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.converted_type) {
    xfer += oprot->writeFieldBegin("converted_type", ::bumblebee::thrift::protocol::T_I32, 6);
    xfer += oprot->writeI32((int32_t)this->converted_type);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.scale) {
    xfer += oprot->writeFieldBegin("scale", ::bumblebee::thrift::protocol::T_I32, 7);
    xfer += oprot->writeI32(this->scale);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.precision) {
    xfer += oprot->writeFieldBegin("precision", ::bumblebee::thrift::protocol::T_I32, 8);
    xfer += oprot->writeI32(this->precision);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.field_id) {
    xfer += oprot->writeFieldBegin("field_id", ::bumblebee::thrift::protocol::T_I32, 9);
    xfer += oprot->writeI32(this->field_id);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.logicalType) {
    xfer += oprot->writeFieldBegin("logicalType", ::bumblebee::thrift::protocol::T_STRUCT, 10);
...
uint32_t DataPageHeader::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t DataPageHeader::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DataPageHeader");

  xfer += oprot->writeFieldBegin("num_values", ::bumblebee::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32(this->num_values);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("encoding", ::bumblebee::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32((int32_t)this->encoding);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("definition_level_encoding", ::bumblebee::thrift::protocol::T_I32, 3);
  xfer += oprot->writeI32((int32_t)this->definition_level_encoding);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("repetition_level_encoding", ::bumblebee::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32((int32_t)this->repetition_level_encoding);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.statistics) {
    xfer += oprot->writeFieldBegin("statistics", ::bumblebee::thrift::protocol::T_STRUCT, 5);
...
uint32_t IndexPageHeader::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t IndexPageHeader::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t DictionaryPageHeader::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t DictionaryPageHeader::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  ...
  if (this->__isset.is_sorted) {
    xfer += oprot->writeFieldBegin("is_sorted", ::bumblebee::thrift::protocol::T_BOOL, 3);
...
uint32_t DataPageHeaderV2::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t DataPageHeaderV2::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  ...
  xfer += oprot->writeFieldBegin("num_nulls", ::bumblebee::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32(this->num_nulls);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("num_rows", ::bumblebee::thrift::protocol::T_I32, 3);
  xfer += oprot->writeI32(this->num_rows);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("encoding", ::bumblebee::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32((int32_t)this->encoding);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("definition_levels_byte_length", ::bumblebee::thrift::protocol::T_I32, 5);
  xfer += oprot->writeI32(this->definition_levels_byte_length);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("repetition_levels_byte_length", ::bumblebee::thrift::protocol::T_I32, 6);
  xfer += oprot->writeI32(this->repetition_levels_byte_length);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.is_compressed) {
    xfer += oprot->writeFieldBegin("is_compressed", ::bumblebee::thrift::protocol::T_BOOL, 7);
    xfer += oprot->writeBool(this->is_compressed);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.statistics) {
    xfer += oprot->writeFieldBegin("statistics", ::bumblebee::thrift::protocol::T_STRUCT, 8);
    xfer += this->statistics.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
...
uint32_t PageHeader::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t PageHeader::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  ...
  xfer += oprot->writeFieldBegin("uncompressed_page_size", ::bumblebee::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32(this->uncompressed_page_size);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("compressed_page_size", ::bumblebee::thrift::protocol::T_I32, 3);
  xfer += oprot->writeI32(this->compressed_page_size);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.crc) {
    xfer += oprot->writeFieldBegin("crc", ::bumblebee::thrift::protocol::T_I32, 4);
    xfer += oprot->writeI32(this->crc);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.data_page_header) {
    xfer += oprot->writeFieldBegin("data_page_header", ::bumblebee::thrift::protocol::T_STRUCT, 5);
    xfer += this->data_page_header.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.index_page_header) {
    xfer += oprot->writeFieldBegin("index_page_header", ::bumblebee::thrift::protocol::T_STRUCT, 6);
    xfer += this->index_page_header.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.dictionary_page_header) {
    xfer += oprot->writeFieldBegin("dictionary_page_header", ::bumblebee::thrift::protocol::T_STRUCT, 7);
    xfer += this->dictionary_page_header.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.data_page_header_v2) {
    xfer += oprot->writeFieldBegin("data_page_header_v2", ::bumblebee::thrift::protocol::T_STRUCT, 8);
...
uint32_t KeyValue::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t KeyValue::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("KeyValue");

  xfer += oprot->writeFieldBegin("key", ::bumblebee::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->key);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.value) {
    xfer += oprot->writeFieldBegin("value", ::bumblebee::thrift::protocol::T_STRING, 2);
...
uint32_t SortingColumn::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t SortingColumn::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("SortingColumn");

  xfer += oprot->writeFieldBegin("column_idx", ::bumblebee::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32(this->column_idx);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("descending", ::bumblebee::thrift::protocol::T_BOOL, 2);
  xfer += oprot->writeBool(this->descending);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("nulls_first", ::bumblebee::thrift::protocol::T_BOOL, 3);
...
uint32_t PageEncodingStats::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t PageEncodingStats::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("PageEncodingStats");

  xfer += oprot->writeFieldBegin("page_type", ::bumblebee::thrift::protocol::T_I32, 1);
  ...
  xfer += oprot->writeFieldBegin("count", ::bumblebee::thrift::protocol::T_I32, 3);
...
uint32_t ColumnMetaData::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
        ...
        break;
      case 2:
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            this->encodings.clear();
            uint32_t _size68;
            ::bumblebee::thrift::protocol::TType _etype71;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size74;
            ::bumblebee::thrift::protocol::TType _etype77;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size80;
            ::bumblebee::thrift::protocol::TType _etype83;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size85;
            ::bumblebee::thrift::protocol::TType _etype88;
...
uint32_t ColumnMetaData::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  ...
  xfer += oprot->writeFieldBegin("encodings", ::bumblebee::thrift::protocol::T_LIST, 2);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_I32, static_cast<uint32_t>(this->encodings.size()));
  ...
  xfer += oprot->writeFieldBegin("path_in_schema", ::bumblebee::thrift::protocol::T_LIST, 3);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRING, static_cast<uint32_t>(this->path_in_schema.size()));
  ...
  xfer += oprot->writeFieldBegin("codec", ::bumblebee::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32((int32_t)this->codec);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("num_values", ::bumblebee::thrift::protocol::T_I64, 5);
  xfer += oprot->writeI64(this->num_values);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("total_uncompressed_size", ::bumblebee::thrift::protocol::T_I64, 6);
  xfer += oprot->writeI64(this->total_uncompressed_size);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("total_compressed_size", ::bumblebee::thrift::protocol::T_I64, 7);
  xfer += oprot->writeI64(this->total_compressed_size);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.key_value_metadata) {
    xfer += oprot->writeFieldBegin("key_value_metadata", ::bumblebee::thrift::protocol::T_LIST, 8);
    {
      xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->key_value_metadata.size()));
  ...
  xfer += oprot->writeFieldBegin("data_page_offset", ::bumblebee::thrift::protocol::T_I64, 9);
  xfer += oprot->writeI64(this->data_page_offset);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.index_page_offset) {
    xfer += oprot->writeFieldBegin("index_page_offset", ::bumblebee::thrift::protocol::T_I64, 10);
    xfer += oprot->writeI64(this->index_page_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.dictionary_page_offset) {
    xfer += oprot->writeFieldBegin("dictionary_page_offset", ::bumblebee::thrift::protocol::T_I64, 11);
    xfer += oprot->writeI64(this->dictionary_page_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.statistics) {
    xfer += oprot->writeFieldBegin("statistics", ::bumblebee::thrift::protocol::T_STRUCT, 12);
    xfer += this->statistics.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.encoding_stats) {
    xfer += oprot->writeFieldBegin("encoding_stats", ::bumblebee::thrift::protocol::T_LIST, 13);
    {
      xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->encoding_stats.size()));
...
uint32_t EncryptionWithFooterKey::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t EncryptionWithFooterKey::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t EncryptionWithColumnKey::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            this->path_in_schema.clear();
            uint32_t _size98;
            ::bumblebee::thrift::protocol::TType _etype101;
...
uint32_t EncryptionWithColumnKey::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("EncryptionWithColumnKey");

  xfer += oprot->writeFieldBegin("path_in_schema", ::bumblebee::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRING, static_cast<uint32_t>(this->path_in_schema.size()));
  ...
  if (this->__isset.key_metadata) {
    xfer += oprot->writeFieldBegin("key_metadata", ::bumblebee::thrift::protocol::T_STRING, 2);
...
uint32_t ColumnCryptoMetaData::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t ColumnCryptoMetaData::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ColumnCryptoMetaData");

  if (this->__isset.ENCRYPTION_WITH_FOOTER_KEY) {
    xfer += oprot->writeFieldBegin("ENCRYPTION_WITH_FOOTER_KEY", ::bumblebee::thrift::protocol::T_STRUCT, 1);
    xfer += this->ENCRYPTION_WITH_FOOTER_KEY.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.ENCRYPTION_WITH_COLUMN_KEY) {
    xfer += oprot->writeFieldBegin("ENCRYPTION_WITH_COLUMN_KEY", ::bumblebee::thrift::protocol::T_STRUCT, 2);
...
uint32_t ColumnChunk::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t ColumnChunk::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ColumnChunk");

  if (this->__isset.file_path) {
    xfer += oprot->writeFieldBegin("file_path", ::bumblebee::thrift::protocol::T_STRING, 1);
    xfer += oprot->writeString(this->file_path);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldBegin("file_offset", ::bumblebee::thrift::protocol::T_I64, 2);
  xfer += oprot->writeI64(this->file_offset);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.meta_data) {
    xfer += oprot->writeFieldBegin("meta_data", ::bumblebee::thrift::protocol::T_STRUCT, 3);
    xfer += this->meta_data.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.offset_index_offset) {
    xfer += oprot->writeFieldBegin("offset_index_offset", ::bumblebee::thrift::protocol::T_I64, 4);
    xfer += oprot->writeI64(this->offset_index_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.offset_index_length) {
    xfer += oprot->writeFieldBegin("offset_index_length", ::bumblebee::thrift::protocol::T_I32, 5);
    xfer += oprot->writeI32(this->offset_index_length);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.column_index_offset) {
    xfer += oprot->writeFieldBegin("column_index_offset", ::bumblebee::thrift::protocol::T_I64, 6);
    xfer += oprot->writeI64(this->column_index_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.column_index_length) {
    xfer += oprot->writeFieldBegin("column_index_length", ::bumblebee::thrift::protocol::T_I32, 7);
    xfer += oprot->writeI32(this->column_index_length);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.crypto_metadata) {
    xfer += oprot->writeFieldBegin("crypto_metadata", ::bumblebee::thrift::protocol::T_STRUCT, 8);
    xfer += this->crypto_metadata.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.encrypted_column_metadata) {
    xfer += oprot->writeFieldBegin("encrypted_column_metadata", ::bumblebee::thrift::protocol::T_STRING, 9);
...
uint32_t RowGroup::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            this->columns.clear();
            uint32_t _size110;
            ::bumblebee::thrift::protocol::TType _etype113;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size115;
            ::bumblebee::thrift::protocol::TType _etype118;
      ...
      case 6:
        ...
        break;
      case 7:
        if (ftype == ::bumblebee::thrift::protocol::T_I16) {
...
uint32_t RowGroup::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("RowGroup");

  xfer += oprot->writeFieldBegin("columns", ::bumblebee::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->columns.size()));
  ...
  xfer += oprot->writeFieldBegin("total_byte_size", ::bumblebee::thrift::protocol::T_I64, 2);
  xfer += oprot->writeI64(this->total_byte_size);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("num_rows", ::bumblebee::thrift::protocol::T_I64, 3);
  xfer += oprot->writeI64(this->num_rows);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.sorting_columns) {
    xfer += oprot->writeFieldBegin("sorting_columns", ::bumblebee::thrift::protocol::T_LIST, 4);
    {
      xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->sorting_columns.size()));
  ...
  if (this->__isset.file_offset) {
    xfer += oprot->writeFieldBegin("file_offset", ::bumblebee::thrift::protocol::T_I64, 5);
    xfer += oprot->writeI64(this->file_offset);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.total_compressed_size) {
    xfer += oprot->writeFieldBegin("total_compressed_size", ::bumblebee::thrift::protocol::T_I64, 6);
    xfer += oprot->writeI64(this->total_compressed_size);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.ordinal) {
    xfer += oprot->writeFieldBegin("ordinal", ::bumblebee::thrift::protocol::T_I16, 7);
...
uint32_t TypeDefinedOrder::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t TypeDefinedOrder::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t ColumnOrder::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t ColumnOrder::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ColumnOrder");

  if (this->__isset.TYPE_ORDER) {
    xfer += oprot->writeFieldBegin("TYPE_ORDER", ::bumblebee::thrift::protocol::T_STRUCT, 1);
...
uint32_t PageLocation::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t PageLocation::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("PageLocation");

  xfer += oprot->writeFieldBegin("offset", ::bumblebee::thrift::protocol::T_I64, 1);
  xfer += oprot->writeI64(this->offset);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("compressed_page_size", ::bumblebee::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32(this->compressed_page_size);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("first_row_index", ::bumblebee::thrift::protocol::T_I64, 3);
...
uint32_t OffsetIndex::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size130;
            ::bumblebee::thrift::protocol::TType _etype133;
...
uint32_t OffsetIndex::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("OffsetIndex");

  xfer += oprot->writeFieldBegin("page_locations", ::bumblebee::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->page_locations.size()));
...
uint32_t ColumnIndex::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size138;
            ::bumblebee::thrift::protocol::TType _etype141;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size143;
            ::bumblebee::thrift::protocol::TType _etype146;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size148;
            ::bumblebee::thrift::protocol::TType _etype151;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size154;
            ::bumblebee::thrift::protocol::TType _etype157;
...
uint32_t ColumnIndex::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ColumnIndex");

  xfer += oprot->writeFieldBegin("null_pages", ::bumblebee::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_BOOL, static_cast<uint32_t>(this->null_pages.size()));
  ...
  xfer += oprot->writeFieldBegin("min_values", ::bumblebee::thrift::protocol::T_LIST, 2);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRING, static_cast<uint32_t>(this->min_values.size()));
  ...
  xfer += oprot->writeFieldBegin("max_values", ::bumblebee::thrift::protocol::T_LIST, 3);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRING, static_cast<uint32_t>(this->max_values.size()));
  ...
  xfer += oprot->writeFieldBegin("boundary_order", ::bumblebee::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32((int32_t)this->boundary_order);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.null_counts) {
    xfer += oprot->writeFieldBegin("null_counts", ::bumblebee::thrift::protocol::T_LIST, 5);
    {
      xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_I64, static_cast<uint32_t>(this->null_counts.size()));
...
uint32_t AesGcmV1::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t AesGcmV1::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("AesGcmV1");

  if (this->__isset.aad_prefix) {
    xfer += oprot->writeFieldBegin("aad_prefix", ::bumblebee::thrift::protocol::T_STRING, 1);
    xfer += oprot->writeBinary(this->aad_prefix);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.aad_file_unique) {
    xfer += oprot->writeFieldBegin("aad_file_unique", ::bumblebee::thrift::protocol::T_STRING, 2);
    xfer += oprot->writeBinary(this->aad_file_unique);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.supply_aad_prefix) {
    xfer += oprot->writeFieldBegin("supply_aad_prefix", ::bumblebee::thrift::protocol::T_BOOL, 3);
...
uint32_t AesGcmCtrV1::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t AesGcmCtrV1::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
uint32_t EncryptionAlgorithm::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t EncryptionAlgorithm::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("EncryptionAlgorithm");

  if (this->__isset.AES_GCM_V1) {
    xfer += oprot->writeFieldBegin("AES_GCM_V1", ::bumblebee::thrift::protocol::T_STRUCT, 1);
    xfer += this->AES_GCM_V1.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.AES_GCM_CTR_V1) {
    xfer += oprot->writeFieldBegin("AES_GCM_CTR_V1", ::bumblebee::thrift::protocol::T_STRUCT, 2);
...
uint32_t FileMetaData::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            this->schema.clear();
            uint32_t _size171;
            ::bumblebee::thrift::protocol::TType _etype174;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size176;
            ::bumblebee::thrift::protocol::TType _etype179;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            this->key_value_metadata.clear();
            uint32_t _size181;
            ::bumblebee::thrift::protocol::TType _etype184;
        ...
        if (ftype == ::bumblebee::thrift::protocol::T_LIST) {
          {
            ...
            uint32_t _size186;
            ::bumblebee::thrift::protocol::TType _etype189;
...
uint32_t FileMetaData::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("FileMetaData");

  xfer += oprot->writeFieldBegin("version", ::bumblebee::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32(this->version);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("schema", ::bumblebee::thrift::protocol::T_LIST, 2);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->schema.size()));
  ...
  xfer += oprot->writeFieldBegin("row_groups", ::bumblebee::thrift::protocol::T_LIST, 4);
  {
    xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->row_groups.size()));
  ...
  if (this->__isset.key_value_metadata) {
    xfer += oprot->writeFieldBegin("key_value_metadata", ::bumblebee::thrift::protocol::T_LIST, 5);
    {
      xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->key_value_metadata.size()));
  ...
  if (this->__isset.created_by) {
    xfer += oprot->writeFieldBegin("created_by", ::bumblebee::thrift::protocol::T_STRING, 6);
    xfer += oprot->writeString(this->created_by);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.column_orders) {
    xfer += oprot->writeFieldBegin("column_orders", ::bumblebee::thrift::protocol::T_LIST, 7);
    {
      xfer += oprot->writeListBegin(::bumblebee::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->column_orders.size()));
  ...
  if (this->__isset.encryption_algorithm) {
    xfer += oprot->writeFieldBegin("encryption_algorithm", ::bumblebee::thrift::protocol::T_STRUCT, 8);
    xfer += this->encryption_algorithm.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.footer_signing_key_metadata) {
    xfer += oprot->writeFieldBegin("footer_signing_key_metadata", ::bumblebee::thrift::protocol::T_STRING, 9);
...
uint32_t FileCryptoMetaData::read(::bumblebee::thrift::protocol::TProtocol* iprot) {
...
uint32_t FileCryptoMetaData::write(::bumblebee::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::bumblebee::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("FileCryptoMetaData");

  xfer += oprot->writeFieldBegin("encryption_algorithm", ::bumblebee::thrift::protocol::T_STRUCT, 1);
  xfer += this->encryption_algorithm.write(oprot);
  xfer += oprot->writeFieldEnd();
